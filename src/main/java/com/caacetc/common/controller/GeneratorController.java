...
import com.caacetc.common.service.GeneratorService;
import com.caacetc.common.utils.GenUtils;
...
public class GeneratorController {
	...
	public void code(HttpServletRequest request, HttpServletResponse response,
		...
		response.reset();
		response.setHeader("Content-Disposition", "attachment; filename=\"caacetc.zip\"");
